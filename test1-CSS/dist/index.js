...
function addAnimationEvent(event) {
    recte === null || recte === void 0 ? void 0 : recte.addEventListener(event, addAnimation);
}
function removeAnimationEvent(event) {
    recte === null || recte === void 0 ? void 0 : recte.addEventListener(event, removeAnimation);
}
