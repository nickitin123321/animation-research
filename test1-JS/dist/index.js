...
const width = svg === null || svg === void 0 ? void 0 : svg.getBoundingClientRect().width;
const height = svg === null || svg === void 0 ? void 0 : svg.getBoundingClientRect().height;
let coordX = 0;
let coordY = 0;
const v = 5;
...
function step(t) {
    ...
    if (coordX > width - 100) {
        ...
        if (coordY > height - 100) {
            coordX2 -= v;
            object === null || object === void 0 ? void 0 : object.setAttribute('transform', `translate(${coordX2} ${height - 100})`);
        }
        if (coordX2 < 0) {
            coordY2 -= v;
            object === null || object === void 0 ? void 0 : object.setAttribute('transform', `translate(${0} ${coordY2})`);
        }
        if (coordY2 < 0) {
